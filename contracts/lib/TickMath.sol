...
/// @title 用于从tick计算sqrt价格的数学库，反之亦然
...
library TickMath {
    ...
    function getSqrtRatioAtTick(int24 tick) internal view returns (uint256 sqrtPriceX96) {
    ...
    function getTickAtSqrtRatio(uint256 sqrtPriceX96) internal view returns (int24 tick) {
